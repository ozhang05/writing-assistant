...
export default function PromptGenerator({setDisplayObject, setPromptText}) {
...
const generateOutline = (prompt) => {
    setPromptText(prompt)
    setDisplayObject('outline')
}
  ...
  return (
    <main className="container">
      ...
      <form onSubmit={handleSubmit}>
            ...
            <SelectInput label="Purpose/Tone" name="purpose" options={PURPOSE_TONE} value={formData.purpose} onChange={handleChange} />
        ...
        <pre>
            ...
            {
                output && 
                <button onClick={() => generateOutline(output)} className="toggle-btn">
                    {"Generate Outline"}
                </button>
            }
        </pre>
